...
DWORD64 get_reflective_loader_offset(DWORD64 base_address, LPCSTR ReflectiveLoader_name)
{
    ...
    printf("check 1 get reflective loader\n");
    ...
    printf("error loader reflective\n");
...
int main(int argc, char* argv[])
{
    ...
    HANDLE file_handle = CreateFileA("E:\\2-2025\\TanCongMang\\HR\\2024\\Cau_2\\tutorial\\Test_ReflectiveDll\\dll_of_loader\\dll_of_loader.dll", GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
    ...
    printf("address %p\n", (BYTE*)remote_file_buf_address + reflective_loader_offset);
