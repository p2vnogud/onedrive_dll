...
#pragma comment(linker, "/export:GetFileVersionInfoA=version1.GetFileVersionInfoA,@1")
#pragma comment(linker, "/export:GetFileVersionInfoByHandle=version1.GetFileVersionInfoByHandle,@2")
#pragma comment(linker, "/export:GetFileVersionInfoExA=version1.GetFileVersionInfoExA,@3")
#pragma comment(linker, "/export:GetFileVersionInfoExW=version1.GetFileVersionInfoExW,@4")
#pragma comment(linker, "/export:GetFileVersionInfoSizeA=version1.GetFileVersionInfoSizeA,@5")
#pragma comment(linker, "/export:GetFileVersionInfoSizeExA=version1.GetFileVersionInfoSizeExA,@6")
#pragma comment(linker, "/export:GetFileVersionInfoSizeExW=version1.GetFileVersionInfoSizeExW,@7")
#pragma comment(linker, "/export:GetFileVersionInfoSizeW=version1.GetFileVersionInfoSizeW,@8")
#pragma comment(linker, "/export:GetFileVersionInfoW=version1.GetFileVersionInfoW,@9")
#pragma comment(linker, "/export:VerFindFileA=version1.VerFindFileA,@10")
#pragma comment(linker, "/export:VerFindFileW=version1.VerFindFileW,@11")
#pragma comment(linker, "/export:VerInstallFileA=version1.VerInstallFileA,@12")
#pragma comment(linker, "/export:VerInstallFileW=version1.VerInstallFileW,@13")
#pragma comment(linker, "/export:VerLanguageNameA=version1.VerLanguageNameA,@14")
#pragma comment(linker, "/export:VerLanguageNameW=version1.VerLanguageNameW,@15")
#pragma comment(linker, "/export:VerQueryValueA=version1.VerQueryValueA,@16")
#pragma comment(linker, "/export:VerQueryValueW=version1.VerQueryValueW,@17")


#define ElementsNumber 12806
#define SizeOfShellcode 204896
